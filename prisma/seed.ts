...
async function main() {
  ...
  const teacherUser = await prisma.user.upsert({
    where: { email: "teacher@Surakshit.test" },
    update: {},
    create: {
      username: "teacher1",
      email: "teacher@Surakshit.test",
  ...
  const student1User = await prisma.user.upsert({
    where: { email: "student1@Surakshit.test" },
    update: {},
    create: {
      username: "student1",
      email: "student1@Surakshit.test",
      password: passwordHash,
      name: "Student One",
      userType: "STUDENT",
    },
  ...
  const student2User = await prisma.user.upsert({
    where: { email: "student2@Surakshit.test" },
    update: {},
    create: {
      username: "student2",
      email: "student2@Surakshit.test",
      password: passwordHash,
      name: "Student Two",
      userType: "STUDENT",
    },
