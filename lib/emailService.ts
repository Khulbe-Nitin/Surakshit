              ...
              <tr>
                <td style="background-color: #f9fafb; padding: 20px; text-align: center; border-top: 1px solid #e5e7eb;">
                  <p style="margin: 0 0 10px 0; color: #6b7280; font-size: 12px;">
                    You received this email because you subscribed to Surakshit alerts.
                  </p>
                  <p style="margin: 0; color: #9ca3af; font-size: 11px;">
                    © ${new Date().getFullYear()} Surakshit. All rights reserved.
                  </p>
                </td>
              </tr>
            </table>
...
export async function sendEmail(options: EmailOptions): Promise<boolean> {
  try {
    ...
    const mailOptions = {
      from: process.env.SMTP_FROM || 'alerts@Surakshit.com',
      to: options.to,
            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
              <tr>
                <td style="background-color: #2563eb; padding: 30px; text-align: center;">
                  <h1 style="margin: 0; color: #ffffff; font-size: 28px;">Welcome to Surakshit Alerts</h1>
                </td>
              </tr>
              <tr>
                <td style="padding: 40px 30px;">
                  <p style="font-size: 16px; color: #374151; margin: 0 0 20px 0;">
                    Thank you for subscribing to Surakshit safety alerts!
                  </p>
...
© ${new Date().getFullYear()} Surakshit. All rights reserved.
  ...
  return await sendEmail({
    to: email,
    subject: 'Welcome to Surakshit Alerts',
    html,
    text,
  });
}
