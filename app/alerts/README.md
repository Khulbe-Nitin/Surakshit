# Surakshit Alert System

A comprehensive alert system for Surakshit that fetches disaster and safety alerts from various sources and sends email notifications to subscribed users using OpenSMTPD.
...
SMTP_PORT=25
SMTP_SECURE=false
SMTP_FROM=alerts@Surakshit.com
