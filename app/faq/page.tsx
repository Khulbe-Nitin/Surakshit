...
const faqData: FAQItem[] = [
  ...
  {
    category: "Platform",
    question: "What is Surakshit?",
    answer: "Surakshit is a gamified disaster preparedness platform designed specifically for schools. It combines interactive educational games, comprehensive learning modules, and real-time analytics to help students, teachers, and administrators prepare for various natural disasters including earthquakes, floods, tsunamis, volcanoes, and forest fires.",
    icon: "🏫",
  },
  {
    category: "Platform",
    question: "Who can use Surakshit?",
    answer: "Surakshit is designed for three types of users: Students who can play games and complete modules to learn about disaster preparedness, Teachers who can track student progress and manage class activities, and Administrators who can oversee the entire system and access detailed analytics.",
    icon: "👥",
  },
  {
    category: "Platform",
...
const categories = [
  ...
  { name: "Using Surakshit", icon: "🎮", color: "from-purple-500 to-indigo-600" },
];
        ...
        <div className="relative container mx-auto px-4 py-20 md:py-28">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed animate-fade-in-up animation-delay-200">
              Everything you need to know about disaster preparedness and Surakshit
            </p>
          ...
          <div className="relative bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 rounded-3xl p-1 shadow-2xl">
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-10 md:p-12">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <a
                  href="mailto:support@Surakshit.edu"
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <div className="text-lg font-bold">support@Surakshit.edu</div>
                  </div>
